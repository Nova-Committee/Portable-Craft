 ...
 * Version: 1.0
 */
public abstract class AbstractRepairScreen<T extends AbstractRepairedContainer> extends AbstractContainerScreen<T> implements ContainerListener {
    private ResourceLocation menuResource;

    public AbstractRepairScreen(T pItemCombinerMenu, Inventory pPlayerInventory, Component pTitle, ResourceLocation pMenuTexture) {
    ...
    protected void renderFg(PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTicks) {
    }
