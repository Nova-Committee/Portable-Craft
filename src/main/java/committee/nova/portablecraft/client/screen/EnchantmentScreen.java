 ...
 * Version: 1.0
 */
public class EnchantmentScreen extends AbstractContainerScreen<EnchantmentContainer> {
    ...
    public EnchantmentScreen(EnchantmentContainer pEnchantmentMenu, Inventory pPlayerInventory, Component pTitle) {
