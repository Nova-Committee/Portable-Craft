...
public class RepairContainer extends AbstractRepairedContainer {
    ...
    public RepairContainer(int pContainerId, PlayerInventory pPlayerInventory) {
        super(ModContainers.ANVIL, pContainerId, pPlayerInventory);
        this.addDataSlot(this.cost);
    }

    public static RepairContainer create(int pContainerId, PlayerInventory playerInventory, PacketBuffer buffer){
        return new RepairContainer(pContainerId, playerInventory);
    }
