...
public class EnchantmentEditItem extends Item {
    ...
    private static final ITextComponent CONTAINER_TITLE = new TranslationTextComponent("container.disenchant");
    ...
    public ActionResult<ItemStack> use(World pLevel, PlayerEntity pPlayer, Hand pHand) {
        if (!pLevel.isClientSide && !pPlayer.isCrouching()) {
            pPlayer.openMenu(new SimpleNamedContainerProvider((p_235576_2_, p_235576_3_, p_235576_4_) -> {
                return new EnchantmentEditContainer(p_235576_2_, p_235576_3_);
            }, CONTAINER_TITLE));
